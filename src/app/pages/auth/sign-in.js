...
import { loginWithUserName, getUserDetails } from "../../store/action";
        ...
        loginWithUserName(temp_payload, (data) => {
          if (data && data?.status == 200) {
            if (data?.data?.status?.status == 1) {
              ...
              setLocalStorage(
                commonConstants.LOCAL_STORAGE_REFRESH_TOKEN_KEY,
                data?.data?.refresh_key
              );
            }
            getProfileDetails();
          } else {
                ...
                <Card className='card-transparent shadow-none d-flex justify-content-center mb-0 auth-card'>
                  <Card.Body>
                    ...
                    >
                      ...
                      <h4 className='logo-title ms-3'>{appConfig.appName}</h4>
                    </Link>
