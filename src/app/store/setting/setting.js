...
export const SubHeaderDataAction = (value = "") => {
  if (value) {
    return (dispatch) => {
      dispatch({ type: "SIDEBARDATA", value });
    };
  }
};
...
export const getSubHeaderData = (state) => state.mode.subHeaderData;
